  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error;
        toast({ title: 'Account created!', description: 'Check your email to confirm your registration.' });
      }
    } catch (err: any) {
            ...
            {!isLogin && (
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" value={fullName} onChange={e => setFullName(e.target.value)} placeholder="Your name" className="pl-10" required />
                </div>
              </div>
            )}
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@email.com" className="pl-10" required />
              </div>
            </div>
            <div className="space-y-2">
