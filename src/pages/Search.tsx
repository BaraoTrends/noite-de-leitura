        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-24 space-y-6">
              <div className="bg-card rounded-xl p-5 border border-border">
                ...
                {/* Age Ratings */}
                <div>
                  <h4 className="text-sm font-medium text-muted-foreground mb-3">Classificação</h4>
                  <div className="space-y-2">
                    {AGE_RATINGS.map((rating) => (
                      <label key={rating} className="flex items-center gap-2 cursor-pointer">
                        <Checkbox
                          checked={selectedAgeRatings.includes(rating)}
                          onCheckedChange={() => toggleAgeRating(rating)}
                        />
          ...
          <div className="lg:hidden mb-4">
            ...
            >
              ...
              Filtros {hasFilters && `(${selectedCategories.length + selectedAgeRatings.length})`}
            </Button>
            ...
            {showFilters && (
              <motion.div
                ...
                className="mt-4 bg-card rounded-xl p-5 border border-border"
              >
          ...
          <div className="flex-1 min-w-0">
            ...
            {results.length === 0 ? (
              <div className="text-center py-20">
                ...
                <p className="text-muted-foreground">
                  Tente buscar com outras palavras ou ajustar os filtros.
                </p>
              </div>
            ) : (
