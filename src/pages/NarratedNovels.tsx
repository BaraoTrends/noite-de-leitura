        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Ouça suas histórias favoritas narradas profissionalmente. 
              Perfeito para quando você quer relaxar ou está em movimento.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button variant="outline" size="lg" asChild>
                <a href="https://youtube.com/@novelbrasil/playlists" target="_blank" rel="noopener noreferrer">
        ...
        >
          <div className="aspect-video rounded-xl overflow-hidden card-shadow border border-border">
            <iframe
              ...
              title="Playlist de Novels Narradas"
              frameBorder="0"
        ...
        {novelsWithVideo.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-muted-foreground mb-4">
              Nenhuma novel com narração disponível no momento.
            </p>
            <p className="text-sm text-muted-foreground">
              Estamos sempre adicionando novas narrações. Inscreva-se no canal para ser notificado!
            </p>
          </div>
        ) : (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            >
              ...
              <p className="text-muted-foreground">Novels Narradas</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
